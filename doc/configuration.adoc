...
|dictionary
|
|Colors to use in system-color-based themes for branded clients. Mutually exclusive with theme-definitions.
[cols="1,1"]
!===
! Key
! Value
...
! The color of the status bar in the setup wizard. Can be either `default`, `black` or `white`.
