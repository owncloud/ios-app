...
- [ ] [DEV] Update In-App Release Notes (changelog) in [ownCloud/Release Notes/ReleaseNotes.plist](https://github.com/owncloud/ios-app/blob/master/ownCloud/Release Notes/ReleaseNotes.plist)
- [ ] [QA] Design Test plan
