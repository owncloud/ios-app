...
extension SearchScope {
	...
	static public func recipientSearch(with context: ClientContext, cellStyle: CollectionViewCellStyle, item: OCItem, localizedName: String) -> SearchScope {
		return RecipientSearchScope(with: context, cellStyle: cellStyle, item: item, localizedName: localizedName, localizedPlaceholder: "Search for users or groups".localized, icon: OCSymbol.icon(forSymbolName: "person.circle"))
	}
}
