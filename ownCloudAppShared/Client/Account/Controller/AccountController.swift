		...
		if let core = connection?.core {
			...
			if configuration.showQuickAccess {
				...
				if specialItems[.recents] == nil {
					specialItems[.recents] = OCSavedSearch(scope: .account, location: nil, name: "Recents".localized, isTemplate: false, searchTerm: ":1w :file").withCustomIcon(name: "clock.arrow.circlepath").useNameAsTitle(true)
