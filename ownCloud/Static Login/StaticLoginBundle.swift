...
public class StaticLoginBundle: NSObject {
	public var organizationLogoImage : UIImage?
	public var organizationBackgroundImage : UIImage?
	public var organizationName : String?

	public var loginThemeStyleID : ThemeStyleIdentifier?

	public var profiles : [StaticLoginProfile] = []

	public static var defaultBundle : StaticLoginBundle {
