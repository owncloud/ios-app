...
public class CardIssueMessagePresenter: OCMessagePresenter {
	...
	public override func presentationPriority(for message: OCMessage) -> OCMessagePresentationPriority {
	...
	public override func present(_ message: OCMessage, completionHandler: @escaping (OCMessagePresentationResult, OCMessageChoice?) -> Void) {
