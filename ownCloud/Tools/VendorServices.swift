...
public class VendorServices : NSObject {
	...
	public var feedbackMail: String? {
		if self.isBranded, let bundleValues = self.brandingProperties, let feedbackMail = bundleValues["feedbackMail"] as? String {
			return feedbackMail
		} else if let feedbackMail = FeedbackSettings.classSetting(forOCClassSettingsKey: .feedbackEmail) as? String {
			return feedbackMail
		}
	...
	public static var shared : VendorServices = {
	...
	public func recommendToFriend(from viewController: UIViewController) {
		...
		guard let appStoreLink = FeedbackSettings.classSetting(forOCClassSettingsKey: .appStoreLink) as? String,
...
extension OCClassSettingsIdentifier {
	public static let app = OCClassSettingsIdentifier("app")
}

extension OCClassSettingsKey {
	public static let showBetaWarning = OCClassSettingsKey("show-beta-warning")
	public static let isBetaBuild = OCClassSettingsKey("is-beta-build")
	public static let enableUIAnimations = OCClassSettingsKey("enable-ui-animations")
	public static let enableReviewPrompt = OCClassSettingsKey("enable-review-prompt")
}
