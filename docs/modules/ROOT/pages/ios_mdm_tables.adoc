...
|branding.allowed-authentication-methods
|stringArray
|
|Profile: allowed authentication methods
|advanced `candidate`

|branding.allowed-hosts
|stringArray
|
|Profile: allowed hosts
|advanced `candidate`

|branding.bookmark-name
|string
|
|Profile: bookmark name
|advanced `candidate`
...
|branding.can-configure-url
|bool
|
|Profile: can configure URL
|advanced `candidate`
...
|branding.help-url-button-string
|string
|
|Profile: help URL button string
|advanced `candidate`
...
|branding.prompt-for-help-url
|string
|
|Profile: prompt for help URL
|advanced `candidate`

|branding.prompt-for-password-auth
|string
|
|Profile: prompt for password auth
|advanced `candidate`

|branding.prompt-for-token-auth
|string
|
|Profile: prompt for token auth
|advanced `candidate`

|branding.prompt-for-url
|string
|
|Profile: prompt for URL
|advanced `candidate`
