...
|`Profile` +
**Onbording button title** +
 +
branding.profile-help-button-label
|string
|
|Text used for the onbording button title
|advanced `candidate`
...
|urlString
|
|Optional URL to onbording resources.
|advanced `candidate`
...
|`Profile` +
**Open onbording URL message** +
 +
branding.profile-open-help-message
|string
|
|Message shown in an alert before opening the onbording URL.
|advanced `candidate`
